...
namespace Quản_lý_sinh_viên_PKA
{
    public partial class frmDoiMatKhau : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'quanlydiemDataSet53.tblLOGIN' table. You can move, or remove it, as needed.
            this.tblLOGINTableAdapter.Fill(this.quanlydiemDataSet53.tblLOGIN);
            conn = cc.Connected();
