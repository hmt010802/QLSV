...
namespace Quản_lý_sinh_viên_PKA
{
    public partial class frmQLDiemThiLai : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (txtMaSV.Text == "" || cboMonHoc.Text == "")
            {
                errorProvider1.SetError(txtMaSV, "Mã SV hoặc Tên môn học không để trống!");
                txtMaSV.Focus();
            }
            //else if ()
            //{
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string update = "Update tblKET_QUA2 Set HoTen=N'" + txtHoTen.Text + "',TenMon=N'" +
                                ...
                                txtDiemThi2.Text + "',HocKi=N'" + cboHocKi.Text + "' where MaSV='" + txtMaSV.Text + "' and TenMon=N'" + cboMonHoc.Text + "' and HocKi=N'" + cboHocKi.Text + "' ";
