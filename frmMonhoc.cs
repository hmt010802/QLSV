    ...
    public partial class frmMonHoc : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                cmd1.Dispose();
                // Thực hiện truy vấn
                string insert = "Insert Into tblMON(MaMon,TenMon,SoTC,MaGV,HocKi,MaKhoa)" +
        ...
        private void dgrMON_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            txtSoTC.Text = dgrMON.CurrentRow.Cells[2].Value.ToString();
        ...
        {
            // Thực hiện truy vấn
            string update = "Update tblMON Set TenMon=N'" + txtTenMon.Text + "',SoTC='" + 
                            txtSoTC.Text + "',MaGV='" + txtMaGV.Text + "',HocKi='" +
